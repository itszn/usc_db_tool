...
$('#btn-paths').click(function () {
  (async function () {
    ...
    var flush_charts = async function flush_charts(table) {
      ...
      try {
        for (var _iterator13 = charts_to_flush[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
          var c = _step13.value;
    ...
    try {
      for (var _iterator15 = Object.entries(folder_updates)[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
        var f = _step15.value;
