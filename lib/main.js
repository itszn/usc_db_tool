...
$('#btn-paths').click(function () {
  (async function () {
    ...
    try {
      for (var _iterator9 = all_rows[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
    ...
    var flush_charts = async function flush_charts(table) {
      ...
      try {
        for (var _iterator10 = charts_to_flush[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
          var c = _step10.value;
    ...
    try {
      for (var _iterator12 = Object.entries(folder_updates)[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
        var f = _step12.value;
