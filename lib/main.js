...
function do_stats() {
  ...
  (async function () {
    ...
    for (var level = 20; level >= 10; level--) {
      ...
      try {
        for (var _iterator3 = raw_scores[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      try {
        for (var _iterator4 = raw_misses[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      try {
        for (var _iterator5 = raw_ex[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var _row4 = _step5.value;
      ...
      try {
        for (var _iterator6 = raw_c[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
          var _row6 = _step6.value;
      ...
      try {
        for (var _iterator8 = vf_classes[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          var c = _step8.value;
      ...
      try {
        for (var _iterator9 = score_list[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
...
async function find_folders(all_rows) {
  ...
  try {
    for (var _iterator12 = all_rows[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
...
$('#btn-paths').click(function () {
  (async function () {
    ...
    var flush_charts = async function flush_charts(table) {
      ...
      try {
        for (var _iterator14 = charts_to_flush[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
          var c = _step14.value;
    ...
    try {
      for (var _iterator15 = all_rows[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
    ...
    try {
      for (var _iterator16 = Object.entries(folder_updates)[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
        var f = _step16.value;
